...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  override def mostRetweeted: Tweet = {
    ...
    val rest = all.filter(x => x.retweets > elem.retweets)
    if (rest.isInstanceOf[Empty]) elem else rest.mostRetweeted
  }
  ...
  override def descendingByRetweet: TweetList = {
    ...
    this.remove(mostTweeted)
    new Cons(mostTweeted, descendingByRetweet)
  }
}
